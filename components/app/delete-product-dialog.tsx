...
import { deleteProductAction } from "@/app/(app)/settings/actions";
      ...
      >
        <div className="border-b border-[#ebebeb] px-5 pb-4 pt-5">
          <DialogHeader className="gap-1">
            <DialogTitle className="text-lg font-semibold tracking-tight text-[#333]">Delete product?</DialogTitle>
            <DialogDescription className="text-[13px] leading-snug text-[#858585]">
              This will remove <span className="font-medium text-[#333]">{productName}</span> from your menu. This
              cannot be undone.
            </DialogDescription>
          </DialogHeader>
        </div>
